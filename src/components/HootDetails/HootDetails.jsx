        ...
        <main>
            <header>
                ...
                {   //check to see if i wrote the hoot
                    ...
                    //if check passes, then the delete button appears
...
//https://pages.git.generalassemb.ly/modular-curriculum-all-courses/react-hoot-front-end/build-the-hoot-details-component/#display-comments